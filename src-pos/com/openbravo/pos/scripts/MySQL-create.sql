...
-- Create NCF Table for incrementation
CREATE TABLE  TICKETSNUM_NCF (ID INTEGER NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8;
INSERT INTO TICKETSNUM_NCF VALUES(1);
